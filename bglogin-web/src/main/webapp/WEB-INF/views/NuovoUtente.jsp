...
<meta charset="utf-8">
  ...
  <spring:url value="/resources/css/login.css" var="loginCss" />
	...
	<spring:url value="/resources/images/nuovo_utente.png" var="newuser" />
...
<div id="divLogo"><img alt="ads" src=${logo} /></div>
  ...
  <div class="imgcontainer">
    <img src=${newuser} alt="newuser" class="avatar">
    <h2>Inserisci nuovo utente</h2>
  </div>

<form method="POST" action="<%= request.getContextPath()%>/createUser" id="form" name="form">
 <div class="container">
    ...
    <button type="submit" id="btn" name="btn">Create</button>
